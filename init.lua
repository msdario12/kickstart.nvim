...
if vim.g.vscode then
  ...
  vim.cmd [[source C:/Users/dario/AppData/Local/nvim/vscode/settings.vim]]
  ...
  vim.keymap.set('n', '<leader>fe', require('telescope.builtin').resume, { desc = '[S]earch [R]esume' })
